...
| Golden file | Test | Tolerance | Measured max | Units | Error source |
|---|---|---|---|---|---|
| `golden_lunarnodes.json` | Mean lunar node longitude | 1e-8 | ~1e-9 | degrees | Identical Meeus formula |
| `golden_true_lunarnodes.json` | True lunar node longitude (r×v) | 1e-6 | ~5e-11 | degrees | Identical r×v algorithm, same ephemeris |
| `golden_true_lunarnodes_osculating.json` | True lunar node longitude (osculating) | 1e-6 | ~4e-11 | degrees | Skyfield osculating_elements_of(), independent code path |
