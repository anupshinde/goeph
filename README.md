...
| `lunarnodes` | `goeph/lunarnodes` | True lunar node from ephemeris state vectors, on the J2000 ecliptic (`TrueNode`, `TrueNodeICRF`); mean node via Meeus polynomial, of date (`MeanLunarNodes`, `MeanLunarNodeICRF`) |
